...
# Q1 dispaly all the directors name

# for mov in movies:
#     print(mov.get("director"))


#Q2 display movie name only have 1 genere
...
# # print(count)
# for mov in movies:
#     if len(mov.get("genres"))==1:
#         print(mov.get("title"))


#Q3 movie has the most run time

# longest_movie = max(movies, key=lambda d: int(d.get("runtime")))
# print("The movie with the longest runtime is:", longest_movie.get("title"))      


#Q4 minimum runtime

# shortest_movie = min(movies, key=lambda d: int(d.get("runtime")))
# print("The movie with the shortest runtime is:", shortest_movie.get("title")) 


#Q5 print the movie using id

# usr_input=int(input("Enter film id: "))
# for movie in movies:
#     if movie.get("id") == usr_input:
#         print(movie.get("title"))            


#Q6 max count of genres

# genre_count={ }
# for mov in movies:
#     genres_text=mov.get("genres")
#     # print(genres_text)
#     for gn in genres_text:
#         if gn in genre_count:
#             genre_count[gn]+=1
#         else:
#             genre_count[gn]=1
# # print(genre_count)
# max_genre=[(v,k) for k,v in genre_count.items()]
# print(max(max_genre))


#Q7 print movie name starts with 's'

# for mov in movies:
#     if mov.get("title").startswith("S"):
#         print(mov.get("title"))



# Q8 print music genre from movie name and plot

# for mov in movies:
#     genres = mov.get("genres")
#     if "Music" in genres:
#         print(mov.get("title"))
#         print(mov.get("plot"))


#Q9 print number of movies released before 2000
...
# Q10 print total no.of movies

# movi=len(movies)
# print(movi)

#Q11 print actors of ice age

# for mov in movies:
#     if mov.get("title")=="Ice Age":
#         print(mov.get("actors"))
    

# #Q12 runtime>150

# run=[m.get("title") for m in movies if int(m.get("runtime"))>150] 
# print(run)


#Q13 count of all the movies in particular year

# yr_count={ }
# for mov in movies:
#     years=mov.get("year")
#     if years in yr_count:
#         yr_count[years]+=1
#     else:
#         yr_count[years]=1
# print(yr_count)
...
#Q14 year in which maximum movies released 
...
# value_key=[(v,k) for k,v in yr_count.items()]
# print(max(value_key))


#Q15 movies has both comedy and drama as genres

# comedy_drama=[mov.get("title") for mov in movies if "Comedy" in mov.get("genres") and "Drama" in mov.get("genres")]
# print(comedy_drama)
